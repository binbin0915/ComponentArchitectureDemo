...
import com.yupfeg.remote.HttpRequestMediator.addDefaultHttpClientFactory
import com.yupfeg.remote.HttpRequestMediator.addHttpClientFactory
import com.yupfeg.remote.HttpRequestMediator.createRequestApi
import com.yupfeg.remote.HttpRequestMediator.getRetrofitInstance
...
object HttpRequestMediator {
    ...
    private fun fetchHttpClientFactory(
        ...
        if (mHttpClientFactories.containsKey(configKey)) {
            return mHttpClientFactories[configKey] ?: throw NullPointerException(
    ...
    fun addDefaultHttpClientFactory(
        configKey: String = DEFAULT_CLIENT_KEY, init: HttpRequestConfig.() -> Unit
    ): HttpRequestMediator {
    ...
    @JvmStatic
    fun addDefaultHttpClientFactory(
        configKey: String = DEFAULT_CLIENT_KEY, config: HttpRequestConfig
    ): HttpRequestMediator {
    ...
    fun addHttpClientFactory(
        configKey: String = DEFAULT_CLIENT_KEY, factory: HttpClientFactory
    ): HttpRequestMediator {
